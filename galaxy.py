...
def load_ours_noHaHb(galaxyname):
    ...
    if galaxyname == 'J0000p3052A':
        gname = 'J0000p3052A'
        T_OIII = 11037.945156685078
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
    elif galaxyname == 'J0000p3052B':
        gname = 'J0000p3052B'
        T_OIII = 14569.154040664962
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
    elif galaxyname == 'J0018p2345':
        gname = 'J0018p2345'
        T_OIII = 16626.638755153213
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
...
#        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
        ...
        gname = 'J0757p4750'
        T_OIII = 11686.549329670448
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
    elif galaxyname == 'J0943p3326':
        gname = 'J0943p3326'
        T_OIII = 19666.29637825492
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
    elif galaxyname == 'J1044p6306':
        gname = 'J1044p6306'
        T_OIII = 18700.
...
#        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
        ...
        gname = 'J1425p4441'
        T_OIII = 12853.652063516092
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
    elif galaxyname == 'J1655p6337':
        gname = 'J1655p6337'
        T_OIII = 9766.507914781401
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
        ...
        gname = 'J1732p4452'
        T_OIII = 17152.80601774715
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
    elif galaxyname == 'J1757p6454':
        gname = 'J1757p6454'
        T_OIII = 12167.337612093677
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
        ...
        gname = 'J2319p1616'
        T_OIII = 18910.304045800578
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
    elif galaxyname == 'J2230m0531':
        gname = 'J2230m0531'
        T_OIII = 13186.700028124002
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
        ...
        gname = 'KJ2'
        T_OIII = 13676.744651909496
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
    elif galaxyname == 'KJ29':
        gname = 'KJ29'
        T_OIII = 10855.597236415373
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
    elif galaxyname == 'KJ5':
        gname = 'KJ5'
        ...
        gname = 'KJ97'
        T_OIII = 10854.409859555377
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
    elif galaxyname == 'test':
        gname = 'test_flux_opt_noHaHb'
        T_OIII = 18000
        full_tbl = Table.read(os.getcwd() + dir + gname, format='ascii', delimiter=' ')
    else:
        print('Galaxy not known: {0:s}'.format(galaxyname))
