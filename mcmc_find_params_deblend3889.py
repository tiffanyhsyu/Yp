...
min_temp, max_temp = 14400, 21600  # electron temperature (K)
...
np.save('{0:s}_{1:d}walkers_{2:d}steps'.format('test_MCMC_run', nwalkers, nmbr), sampler.chain)
#np.save('{0:s}_{1:d}walkers_{2:d}steps'.format('test_BSSemis_CCMred', nwalkers, nmbr), sampler.chain)
