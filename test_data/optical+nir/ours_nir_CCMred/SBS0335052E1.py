...
full_tbl = Table.read(os.getcwd()+'/test_data/SBS0335052E1_nir', format='ascii', delimiter=' ')
...
#    y_plus, temp, log_dens, c_Hb, a_H, a_He, tau_He, n_HI = theta
	...
	if min_y_plus <= y_plus <= max_y_plus and \
		...
		return ( -(temp - 20100)**2 / (0.2*20100)**2 ) # Mrk450
...
np.save('{0:s}_{1:d}walkers_{2:d}steps'.format('SBS0335052E1', nwalkers, nmbr), sampler.chain)
