...
full_tbl = Table.read(os.getcwd()+'/test_data/SBS1415+437No13_nir', format='ascii', delimiter=' ')
...
#    y_plus, temp, log_dens, c_Hb, a_H, a_He, tau_He, n_HI = theta
	...
	if min_y_plus <= y_plus <= max_y_plus and \
		...
		return ( -(temp - 17000)**2 / (0.2*17000)**2 ) # Mrk450
...
np.save('{0:s}_{1:d}walkers_{2:d}steps'.format('SBS1415+437No13', nwalkers, nmbr), sampler.chain)
