...
full_tbl = Table.read(os.getcwd()+'/test_data/SBS1415+437No2_nir', format='ascii', delimiter=' ')
...
np.save('{0:s}_{1:d}walkers_{2:d}steps'.format('SBS1415+437No2', nwalkers, nmbr), sampler.chain)
